...
def main() -> int:
    ...
    lines = [
        ...
        "",
        "After all chunks complete, refresh the FTS5 wiki index:",
        "```powershell",
        "python P:/.agents/scripts/wiki_search.py --collection wiki add --doc-id <slug> --markdown-file P:/.data/wiki/concepts/<slug>.md",
        "```",
        "",
        "---",
        "",
